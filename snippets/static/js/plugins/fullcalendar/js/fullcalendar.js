...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		'<span class="principal" style="background:'+event.principalColor+'">' +
			(event.principal&&event.principal!="待认领" ? event.principal.charAt(0) : '<span class="icon-u-user"></span>') +
		'</span>';
	...
	function render() {
		...
		if (sections) {
			el = $("<div class='fc-toolbar'/>")
				.append('<div class="fc-left"><button class="up-btn up-btn-default calendar_left_btn"><span class="icon-u-menu"></span></button></div>')
